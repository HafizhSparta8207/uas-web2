...
export function EditBookForm({ book, categories }: { book: any, categories: any[] }) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (res.error) {
      setError(res.error || "Gagal memperbarui data buku.");
      toast.error("Gagal memperbarui data buku.");
    } else {
      toast.success("Berhasil memperbarui data buku!");
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              {fileError ? (
                ...
                <p className="text-xs text-gray-500 mt-1">Kosongkan jika tidak ingin mengubah gambar. Maksimal 2MB.</p>
              )}
            </div>
